                        ...
                        <div className="lg:w-[100%] w-[50rem] flex items-center justify-start border border-slate-300 py-3">
                            ...
                            <div className="w-[30%] p-3 border-l border-slate-300 flex items-center justify-start gap-1">
                                {item.categories.length > 0 
                                    ? item.categories.map(i => ( <span key={i.id}>{`${i.name}, `}</span> )) 
                                    : 'Not added...'}
                            </div>
                                ...
                                { getRoleToken() <= 2 &&
                                    <>
                                        <Link href={`/admin/product/edit/${item.id}`}> 
                                            <MdEdit 
                                                className='hover:text-green-500 duration-150 hover:scale-110 transition-all ease-in' /> 
                                        </Link>
                                        <button 
                                            onClick={() => {
                                                deleteData(item.id)}}> 
                                        ...
                                        <Link href={`/admin/product-category/edit/${item.id}`}> 
                                            <FaCirclePlus className='hover:text-purple-500 duration-150 hover:scale-110 transition-all ease-in' /> 
                                        </Link>
                                    </>
                                }
                            </div>
