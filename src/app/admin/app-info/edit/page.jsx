    ...
    <div>
        ...
        <section className='w-[100%] h-auto bg-slate-50'>
            <ul className='mx-auto w-[90%] py-2 flex justify-start gap-2'>
                ...
                <li className='flex items-center justify-start gap-1'>
                <Link href='/admin/app-info'>App Info</Link>
                <GoChevronRight />
                </li>
                <li className='flex items-center justify-start gap-1'>
                <Link href='/admin/app-info/edit' className="font-semibold">Edit App Info</Link>
                </li>
            </ul>
        </section>
        {/*  */}
        ...
        <section className='w-[100%] h-auto flex items-center justify-center'>
            <h1 className='text-[4rem] font-black pt-[3rem] pb-[1rem]'>Edit AppInfo</h1>
        </section>
