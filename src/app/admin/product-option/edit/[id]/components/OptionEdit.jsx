...
export default function OptionEdit({ id }) {
    ...
    async function postData() {
        setIsSubmit(false)
        try{
            const result = await axiosClientAPI.post(`product-option/${id}`, data, config)
            .then((response) => {
        ...
        <div className='lg:w-[100%]'>
            ...
            <div className='w-[100%] mx-auto flex items-center justify-center'>
                <button
                    ...
                    className='py-4 px-12 rounded-lg flex justify-center items-center text-white bg-gradient-to-br from-pink-500 to-red-500 hover:from-pink-500 hover:to-pink-600 duration-150 transition-all'>
                    Submit
                </button>
            </div>
        </div>
