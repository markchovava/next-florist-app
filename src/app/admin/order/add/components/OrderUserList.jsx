    ...
    <div className='mx-auto w-[90%] h-auto pb-[4rem]'>
        ...
        <section className="w-[100%] lg:overflow-hidden overflow-auto">
            ...
            <div className="lg:w-[100%] w-[50rem] font-bold flex items-center justify-start bg-slate-100 py-3">
                ...
                <div className="w-[25%] p-3 border-l border-slate-500">PHONE</div>
                <div className="w-[25%] p-3 border-l border-slate-500">EMAIL</div>
            ...
            { data.length > 0 ? 
                ...
                <div key={item.id} className="lg:w-[100%] w-[50rem] flex items-center justify-start border border-slate-300 py-3">
                    ...
                    <div className="w-[25%] p-3 border-l border-slate-300">
                        {item.phone ? item.phone : 'Not added'}</div>
                    <div className="w-[25%] p-3 border-l border-slate-300">
                        { item.email ? item.email : 'Role Not Added.'} </div>
                    <div className="w-[20%] p-3 border-l border-slate-300 flex justify-start items-center gap-3 text-2xl">
                        <Link href={`/admin/order/add/${item.id}`}> 
